...
% -----------------------------------------------
    ...
    if nargin == 0
        ...
        fprintf('=====================================================\n')
        fprintf('Lasso Weighted FISTA solution with SPAMS solution,');
        ...
        %% lasso_weighted test
        lambda = rand(size(X)); 
        [X_fista, iter] = fista(@grad, Xinit, L, lambda, opts);
        param.lambda     = 1; 
        param.lambda2    = 0;
        param.numThreads = 1; 
        param.mode       = 2; 
        ...
        fprintf('2. cost_fista - cost_spams           = %5f\n', ...
            costfista - costmex);       
        fprintf('...Press any key to end the test\n');
        pause
    end 
